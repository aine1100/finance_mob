...
import { Text, StyleSheet, TextInput, TouchableOpacity, useColorScheme, Platform, StatusBar, View, ScrollView } from "react-native";
            ...
            <View style={styles.content}>
                ...
                >
                    <View style={styles.heroText}>
                        <Text style={{ fontSize: 24, fontWeight: '700', color: '#240F51' }}>Welcome back</Text>
                        <Text style={{ fontSize: 14, fontWeight: '500', color: '#6B7280' }}>Hey you&apos;re back, fill in your details to get back in</Text>
                    </View>
                    ...
                    <View style={styles.actionsRow}>
                        <TouchableOpacity style={styles.secondaryBtn} activeOpacity={0.8} onPress={() => router.push('/auth/signup')}>
