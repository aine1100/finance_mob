        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.heroText}>
                    <Text style={{ fontSize: 24, fontWeight: '600', color: '#240F51' }}>Enter your email and we’ll send you a link to reset your password.</Text>
                </View>
               ...
               <View style={styles.bottomBar}>
                              <TouchableOpacity style={styles.primaryBtn} activeOpacity={0.9} onPress={() => router.replace('/auth/verifyEmail')}>
