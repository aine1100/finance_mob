        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.textWrap}>
                    <Text style={styles.hi}>We have sent an email verification link to your email</Text>
                    <Text style={styles.welcome}>Check your email test@test.com and click the link to verify your email address</Text>
                </View>
            </View>
